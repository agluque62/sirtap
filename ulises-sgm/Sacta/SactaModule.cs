...
namespace Sacta
{
    public class SactaModule
    {
        ...
        /// 
        /// </summary>
        public void GetSectorization()
        {
            if (_State != SactaState.Stopped)
            {
                SendSectAsk();
                Log(false, System.Reflection.MethodBase.GetCurrentMethod().Name, "Petición de Sectorización desde Configuración Operador/Control");
            }
        }
