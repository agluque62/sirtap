...
"C:\Program Files (x86)\IIS\Microsoft Web Deploy V3\msdeploy" -verb:delete -dest:apphostconfig="Default Web Site/NucleoDF/U5kCfg/GestorMantenimiento"
