...
--
-- Dumping data for table `dependenciasats`
--

LOCK TABLES `dependenciasats` WRITE;
/*!40000 ALTER TABLE `dependenciasats` DISABLE KEYS */;
INSERT INTO `dependenciasats` VALUES ('departamento','departamento'),('TWR-E','departamento'),('TWR-N','departamento'),('TWR-S','departamento'),('TWR-W','departamento');
/*!40000 ALTER TABLE `dependenciasats` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `redes` VALUES ('departamento','ATS',3),('departamento','RTB',4),('departamento','RTB2',5),('departamento','RTB3',6);
...
INSERT INTO `sistema` VALUES ('departamento',0,0,0,32,64,32,32,32,0,'224.100.10.1',1000,0,0,4,10,200,3,15,9,15,3,9,32);
...
LOCK TABLES `sistema` WRITE;
/*!40000 ALTER TABLE `sistema` DISABLE KEYS */;
INSERT INTO `sistema` VALUES ('departamento',0,0,0,32,64,32,32,32,0,'224.100.10.1',1000,0,0,4,10,200,3,15,9,15,3,9,40);
/*!40000 ALTER TABLE `sistema` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
...
-- Dump completed on 2021-05-12 12:38:26
