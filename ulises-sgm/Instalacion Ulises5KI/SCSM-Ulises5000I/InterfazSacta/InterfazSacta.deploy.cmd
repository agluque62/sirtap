...
set _DeploySetParametersFile=%RootPath%InterfazSacta.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%InterfazSacta.zip" (
echo "%RootPath%InterfazSacta.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%InterfazSacta.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='C:\\Users\\Administrator\\AppData\\Local\\Temp\\WebSitePublish\\InterfazSacta--1101889536\\obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/UlisesV5000/U5kcfg/InterfazSacta\\App_Data$'
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%InterfazSacta.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='C:\\Users\\Administrator\\AppData\\Local\\Temp\\WebSitePublish\\InterfazSacta--1101889536\\obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/UlisesV5000/U5kcfg/InterfazSacta\\App_Data$' -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%InterfazSacta.deploy-readme.txt" (
...
start notepad "%RootPath%InterfazSacta.deploy-readme.txt"
)
echo =========================================================
goto :eof
