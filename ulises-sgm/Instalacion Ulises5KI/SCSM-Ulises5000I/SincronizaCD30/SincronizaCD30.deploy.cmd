...
set _DeploySetParametersFile=%RootPath%SincronizaCD30.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SincronizaCD30.zip" (
echo "%RootPath%SincronizaCD30.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%SincronizaCD30.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='C:\\Users\\Administrator\\AppData\\Local\\Temp\\WebSitePublish\\SincronizaCD30-2011340792\\obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/UlisesV5000/U5kCfg/SincronizaCD30\\App_Data$'
) else (
...
:usage
echo =========================================================
if not exist "%RootPath%SincronizaCD30.deploy-readme.txt" (
...
start notepad "%RootPath%SincronizaCD30.deploy-readme.txt"
)
echo =========================================================
goto :eof
