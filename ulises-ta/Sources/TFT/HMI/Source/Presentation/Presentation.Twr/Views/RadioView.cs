    ...
    private void Reset(RdButton bt, RdDst dst)
		{
			...
			if (dst.IsConfigurated)
			{
                ...
                else
                {
                    ...
                    bt.SetFrecuencaSel(dst.Frecuencia_Sel);
...
//                    General.SafeLaunchEvent(RdListaFrecuencias, this, new EventArgs<string>(""));
                    //General.SafeLaunchEvent(RdListaFrecuencias, this, 0);
