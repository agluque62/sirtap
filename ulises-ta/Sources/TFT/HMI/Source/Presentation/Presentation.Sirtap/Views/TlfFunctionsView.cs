...
using HMI.Presentation.Sirtap.Properties;  // Miguel
...
namespace HMI.Presentation.Sirtap.Views
{
    ...
    public partial class TlfFunctionsView : UserControl
    {
        ...
        public TlfFunctionsView([ServiceDependency] IModelCmdManagerService cmdManager, [ServiceDependency] StateManagerService stateManager)
        {
            ...
            if (global::HMI.Presentation.Sirtap.Properties.Settings.Default.BigFonts)
            {
            ...
            if (_StateManager.Tlf.AltavozTlfHabilitado)
            {
                ...
                this._CancelBT.ImageNormal = global::HMI.Presentation.Sirtap.Properties.Resources.AnularPeq;
            }
            ...
            if (_StateManager.Tlf.AltavozTlfEstado)
                ...
                this._TlfSpeakerBT.ImageNormal = global::HMI.Presentation.Sirtap.Properties.Resources.HeadPhonesTlf;
