...
#define NLOG_INFO	PLOG_INFO
#define NLOG_ERROR	PLOG_ERROR
#define NLOG_DEBUG	PLOG_DEBUG
#define NLOG_EXCEP	PLOG_EXCEP

#define PLOG_INFO(format, ...)		CodeBase::LogInfo(__FILENAME__, __LINE__, format, ##__VA_ARGS__)
#define PLOG_ERROR(format, ...)		CodeBase::LogError(__FILENAME__, __LINE__, format,##__VA_ARGS__)
#define PLOG_DEBUG(format, ...)		CodeBase::LogDebug(__FILENAME__, __LINE__, format,##__VA_ARGS__)
#define PLOG_EXCEP(x, format, ...)	CodeBase::LogException(__FILENAME__, __LINE__, x, format, ##__VA_ARGS__)
