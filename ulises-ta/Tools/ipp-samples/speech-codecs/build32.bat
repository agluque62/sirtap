...
set all_comp_list=io\audio_renders io\media_buffers io\jitter_buffers core\umc core\vm codec\speech_rtp codec\speech application\usc_speech_codec application\usc_nr application\usc_tones application\usc_ec application\umc_speech_rtp_codec
