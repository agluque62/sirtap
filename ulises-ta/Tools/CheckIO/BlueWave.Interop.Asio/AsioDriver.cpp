	...
	namespace Interop
	{
		namespace Asio
		{
			...
			void AsioDriver::InternalSelectDriver(InstalledDriver^ installedDriver)
			{
				...
				LPVOID pAsio = NULL;
				rc = CoCreateInstance(m_clsid, NULL, CLSCTX_INPROC_SERVER, m_clsid, &pAsio);
				...
				{
					throw gcnew ApplicationException("Error en CoCreateInstance...");
				}
			}
