...
#define EVENT_AUDIO_STREAM_TRANSMITTED EVENT_AUDIO_BASE + EVENT_AUDIO_OFFSET + 4 
...
#define EVENT_AUDIO_FREQUENCY_SET   EVENT_AUDIO_BASE + EVENT_AUDIO_OFFSET + 5 
...
#define EVENT_AUDIO_INTERFACE_SET   EVENT_AUDIO_BASE + EVENT_AUDIO_OFFSET + 6 
...
BYTE USBHostAudioV1SetInterfaceFullBandwidth( BYTE deviceAddress, BYTE iface );
...
BYTE USBHostAudioV1SetSamplingFrequency( BYTE deviceAddress, BYTE *frequency, BYTE interface );
