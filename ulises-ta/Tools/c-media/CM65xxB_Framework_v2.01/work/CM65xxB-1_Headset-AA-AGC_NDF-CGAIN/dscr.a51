...
DeviceDscr:   
	...
	; AGL. Para introducir el NUMERO DE SERIE.
...
$IF(__NUCLEODF__)
	...
	SerialNumberStringDscr:
		db  SerialNumberStringDscrEnd-SerialNumberStringDscr ;; String descriptor length
		db  DSCR_STRING
		db  '2',00
		db	'0',00
		db  '1',00
