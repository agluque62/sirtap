...
;; USB Audio10 Output Terimal 2 Descriptor
...
;; USB Audio10 Feature Unit 3 Descriptor	
T1_FeatureUnit3Dscr:
	db  T1_FeatureUnit3DscrEnd - T1_FeatureUnit3Dscr ;; Descriptor length
	db  DSCR_CS_INTERFACE 	;; Descriptor type
...
T1_FeatureUnit3DscrEnd:	
	
;; USB Audio10 Selector Unit 4 Descriptor	
T1_SelectorUnit4Dscr:
	db	T1_SelectorUnit4DscrEnd - T1_SelectorUnit4Dscr     ;; Descriptor length
	db  DSCR_CS_INTERFACE		;; Descriptor type
	db  AC_SUBTYPE_SELECTOR ;; AC Descriptor subtype
	db  04H									;; ID
	db  01H									;; Number of input pins
	db  03H									;; ID of source 0
	db  0										;; String index of Selector
T1_SelectorUnit4DscrEnd:
