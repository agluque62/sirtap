/* $Id: sip_uri.c 3070 2010-01-21 17:27:32Z bennylp $ */
/* 
...
static pj_str_t pjsip_get_display( pjsip_uri *uri );
static void *pjsip_name_addr_get_uri( pjsip_name_addr *name );
static pj_str_t pjsip_name_addr_get_display( pjsip_name_addr *name );
...
typedef pj_str_t	(*P_GET_DISPLAY)(void*);
...
static pjsip_uri_vptr name_addr_vptr = 
{
    ...
    (P_GET_DISPLAY)	&pjsip_name_addr_get_display
};
