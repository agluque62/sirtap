...
typedef struct pjsip_inv_callback
{
     ...
     * This callback is optional.
     */
    pj_status_t(*on_send_ack)(pjsip_inv_session *inv, pjsip_rx_data *rdata, pjsip_event* e);
	...
	void (*on_reinvite_received)(pjsip_inv_session* inv, const pjsip_event* e, pjsip_tx_data* tdata, int *returned_code, pj_str_t **cause);
...
{	
	...
	/*Indica que el invite se envia hacia el proxy*/
	PJSIP_INV_VIA_PROXY = 0x40000000,
};
...
PJ_DECL(pj_bool_t) pjsip_inv__is_re_invite_radio_type(pjsip_inv_session* inv);
