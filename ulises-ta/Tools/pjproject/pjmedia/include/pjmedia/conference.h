...
/*
enum pjmedia_conf_port_type
{
	PJMEDIA_CONF_UNKNOWN_PORT,
	PJMEDIA_CONF_SND_PORT,
	PJMEDIA_CONF_RING_PORT,
	PJMEDIA_CONF_MONITOR_PORT,
	PJMEDIA_CONF_IAC_PORT,
	PJMEDIA_CONF_IAS_PORT,
	PJMEDIA_CONF_DIA_PORT,
	PJMEDIA_CONF_RADIO_PORT,
	PJMEDIA_CONF_BSS_PORT,
	PJMEDIA_CONF_RECORDING_PORT
};
*/
/**
