...
/* NUCLEO 2014 */
/*
 PJ_DECL(void) pjmedia_session_enable_ec( pjmedia_session *session,
															  unsigned index);
*/
 PJ_DECL(void) pjmedia_session_enable_ec( pjmedia_session *session,
...
PJ_DECL(void) pjmedia_session_set_climax_param( pjmedia_session *session, pj_bool_t NTP_synchronized);
PJ_DECL(void) pjmedia_session_set_request_MAM(pjmedia_session *session, pjmedia_stream * stream);
...
PJ_DECL(pj_status_t) pjmedia_radio_session_modify(pjmedia_session* session, const pjmedia_session_info* si);
