...
//Me he dado cuenta que _snprintf no asegura el caracter NULL y defino esta otra funcion
PJ_DEF(int) mysnprintf(char* const _Buffer, size_t const _BufferCount, char const* const _Format, ...)
{
    int _Result;
    va_list _ArgList;
    ...
    if (_BufferCount > 0) _Buffer[_BufferCount - 1] = 0;                //Me aseguro de que el final del buffer tiene un NULL
    return _Result;
}
