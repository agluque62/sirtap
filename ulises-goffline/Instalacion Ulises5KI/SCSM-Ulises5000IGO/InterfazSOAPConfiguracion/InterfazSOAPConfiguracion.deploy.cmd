...
set _DeploySetParametersFile=%RootPath%InterfazSOAPConfiguracion.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%InterfazSOAPConfiguracion.zip" (
echo "%RootPath%InterfazSOAPConfiguracion.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%InterfazSOAPConfiguracion.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='C:\\Users\\Administrator\\AppData\\Local\\Temp\\WebSitePublish\\InterfazSOAPConfiguracion--647520881\\obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/UlisesV5000/U5kCfg/InterfazSOAPConfiguracion\\App_Data$'
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%InterfazSOAPConfiguracion.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='C:\\Users\\Administrator\\AppData\\Local\\Temp\\WebSitePublish\\InterfazSOAPConfiguracion--647520881\\obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='Default\ Web\ Site/UlisesV5000/U5kCfg/InterfazSOAPConfiguracion\\App_Data$' -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%InterfazSOAPConfiguracion.deploy-readme.txt" (
...
start notepad "%RootPath%InterfazSOAPConfiguracion.deploy-readme.txt"
)
echo =========================================================
goto :eof
