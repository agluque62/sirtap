<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InformeOperadores.aspx.cs" Inherits="InformeOperadores" StylesheetTheme="TemaPaginasConfiguracion"  meta:resourcekey="PageResource1"%>
      ...
      <tr>
        <td align="center">
          <asp:Label ID="LbAplicacion" runat="server" SkinID="LabelCabecera"
                ...
                meta:resourcekey="LB_APLICACION_RES">INFORME ULISES V 5000 I</asp:Label>
          ...
          <asp:ImageButton ID="BtnExcel" Height="40px" ImageUrl="~/Images/excel.png" runat="server" onclick="BtnExcel_Click"  Visible="false" resourcekey="BtnExcelResource1" />
       ...
       <tr>
         ...
         <CR:CrystalReportViewer ID="CRViewerInf" runat="server" 
